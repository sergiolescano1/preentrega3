...
const verificacionProducto = (productoId) => {   //ver si esta o no agregado
...
console.log("No Esta repetido")
    const producto = productos.find(producto => producto.id == productoId) //caso 1: si no se repite agrego todas sus propiedades
